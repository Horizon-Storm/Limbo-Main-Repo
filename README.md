...
This is the central repo for the short film about Limbo.
...
Limbo is an indie animation done by UVU students. 
...
```bash
git clone https://github.com/Horizon-Storm/Limbo-Main-Repo
```
